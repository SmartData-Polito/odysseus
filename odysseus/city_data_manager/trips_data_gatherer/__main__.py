...
from odysseus.city_data_manager.trips_data_gatherer.citi_bike_data_gatherer \
    import CitiBikeDataGatherer
from odysseus.city_data_manager.trips_data_gatherer.louisville_scooter_trips_gatherer \
    import LouisvilleScooterDataGatherer
from odysseus.city_data_manager.trips_data_gatherer.austin_scooter_trips_gatherer \
    import AustinScooterDataGatherer, AustinScooterGeoDataGatherer
from odysseus.city_data_manager.trips_data_gatherer.calgary_scooter_trips_gatherer \
    import CalgaryScooterDataGatherer, CalgaryScooterGeoDataGatherer
from odysseus.city_data_manager.trips_data_gatherer.chicago_scooter_trips_gatherer \
    import ChicagoScooterGeoDataGatherer1, ChicagoScooterGeoDataGatherer2
