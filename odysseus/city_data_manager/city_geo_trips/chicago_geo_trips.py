...
from odysseus.city_data_manager.trips_data_source import ChicagoScooterTrips
from odysseus.city_data_manager.geo_data_source import ChicagoCensusTracts
