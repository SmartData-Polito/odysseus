supply_model_config_grid = {
	...
	"fuel_capacity": [5],
	"vehicle_efficiency": [10000],  # TODO -> this is efficiency [km/l] not consumption [l/km]
	"n_seats": [5],
	...
	"vehicles_zones": [
		frozenset({0: 0}.items()),
		frozenset({0: 0, 1: 0}.items()),
		frozenset({0: 0, 1: 0, 2: 0}.items()),
		frozenset({0: 0, 1: 0, 2: 0, 3: 0}.items())
	],
