...
class DummyCityScenario(AbstractCityScenario):
    ...
    def __init__(
            self, dummy_city_name, dummy_data_source_id, bin_side_length, folder_name="default"
    ):

        super(DummyCityScenario, self).__init__(dummy_city_name, dummy_data_source_id)
