...
from e3f2s.city_data_manager.city_data_source.trips_data_source.norfolk_scooter_trips import NorfolkScooterTrips
from e3f2s.city_data_manager.city_data_source.geo_data_source.norfolk_census_tracts import NorfolkCensusTracts
