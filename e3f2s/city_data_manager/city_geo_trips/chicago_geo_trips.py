...
from e3f2s.city_data_manager.city_data_source.trips_data_source.chicago_scooter_trips import ChicagoScooterTrips
from e3f2s.city_data_manager.city_data_source.geo_data_source.chicago_census_tracts import ChicagoCensusTracts
from e3f2s.city_data_manager.city_data_source.geo_data_source.chicago_community_areas import ChicagoCommunityAreas
from e3f2s.city_data_manager.city_geo_trips.city_geo_trips import CityGeoTrips
from e3f2s.utils.geospatial_utils import get_random_point_from_shape


class ChicagoGeoTrips(CityGeoTrips):

    def __init__(self, city_name="Chicago", trips_data_source_id="city_of_chicago", year=2019, month=7):

        self.city_name = city_name
        super().__init__(self.city_name, trips_data_source_id, year, month)
        self.trips_ds_dict = {
            "city_of_chicago": ChicagoScooterTrips()
        }
