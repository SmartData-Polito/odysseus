...
from e3f2s.city_data_manager.city_data_source.trips_data_source.calgary_scooter_trips import CalgaryScooterTrips
from e3f2s.city_data_manager.city_data_source.geo_data_source.calgary_hexagonal_grid import CalgaryHexagonalGrid
...
class CalgaryGeoTrips(CityGeoTrips):
    ...
    def __init__(self, city_name="Calgary", trips_data_source_id="city_of_calgary", year=2019, month=7):

        self.city_name = city_name
        super().__init__(self.city_name, trips_data_source_id, year, month)
        self.trips_ds_dict = {
            "city_of_calgary": CalgaryScooterTrips()
        }
