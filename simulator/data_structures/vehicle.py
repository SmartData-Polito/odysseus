...
class Vehicle(object):
    ...
    def __init__(self, env, plate, start_zone, vehicle_config, vehicle_cost_conf, sim_scenario_conf, sim_start_time):
        self.env = env
        self.plate = plate
    ...
    def booking(self, booking_request):
        ...
        yield self.soc.get(abs(booking_request["soc_delta"]))
