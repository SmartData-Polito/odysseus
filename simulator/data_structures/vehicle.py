...
class Vehicle(object):
        ...
        def booking(self, booking_request):
            ...
            if self.available:
                ...
                change_status(self, status_dict[-1].get("end_time"), env.now(), "available", self._soc)
                start_soc = self._soc
                ...
                change_status(self, status_dict[-1].get("end_time"), env.now(), "booked", start_soc)
